                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <header>
                                ...
                                <h5>List Of Stream</h5>
                                <span><a href="<c:url value='/addStream' />" style="float:right; margin-right:10px; padding-top: 5px">Add Stream</a></span>
                            </header>
                                        ...
                                        <tr>
                                            ...
                                            <sec:authorize access="hasRole('ADMIN')">
                                                <td style="float: right;"><a href="<c:url value='/edit-stream-${stream.id}' />" class="btn btn-success custom-width">Edit</a>
                                                    <a href="<c:url value='/delete-stream-${stream.id}' />" class="btn btn-danger custom-width">Delete</a></td>
                                            </sec:authorize>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
